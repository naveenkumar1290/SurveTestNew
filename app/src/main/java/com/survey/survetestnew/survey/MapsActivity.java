...
import com.survey.survetestnew.model.Geo;
import com.survey.survetestnew.util.AppController;
                ...
                .setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface d, int id) {
                                ...
                                startActivityForResult(new Intent(Settings.ACTION_LOCATION_SOURCE_SETTINGS), GPS_SETTING_REQUEST_CODE);
                                d.dismiss();
                            }
                        })
